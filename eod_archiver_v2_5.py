...
def main(symbol: str, target_date_str: str):
    ...
    try:
        ...
        if not raw_options or not raw_underlying:
            raise RuntimeError("Data fetch failed: Received no data for options or underlying.")
        ...
        _, _, und_data_enriched = metrics_calculator.calculate_all_metrics(options_df, raw_underlying)
