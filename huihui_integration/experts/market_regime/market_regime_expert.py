...
from data_models import HuiHuiExpertConfigV2_5
...
class UltimateMarketRegimeExpert(BaseHuiHuiExpert):
    ...
    def __init__(self, expert_config: MarketRegimeExpertConfig, config_manager: ConfigManagerV2_5, historical_data_manager):
        ...
        self.regime_engine = MarketRegimeEngineV2_5(config_manager)
    ...
    def analyze(self, data: ProcessedDataBundleV2_5) -> LegendaryRegimeResult:
        ...
        try:
            ...
            volatility_forecast = {
                "1d": self.regime_engine.calculate_volatility_regime(data.underlying_data_enriched),
                "5d": self.regime_engine.calculate_regime_stability(data.underlying_data_enriched),
                "20d": self.regime_engine.calculate_flow_intensity(data.underlying_data_enriched)
            }
